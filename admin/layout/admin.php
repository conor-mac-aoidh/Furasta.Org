...
<div id="dialog">&nbsp;</div>
	<div id="wrapper">
		...
		<div id="bottom">
                        <p class="right"><a href="settings.php?page=edit-users&id=' . $User->id . '">'. $User->name .'</a> - Group: <a href="settings.php?page=edit-groups&name=' . str_replace( ' ', '-', $User->group ) . '">'. $User->group . '</a></p>
